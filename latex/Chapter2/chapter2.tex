...
Shannon entropy ($H$) can be used in the context of DNA methylation analysis to \textbf{estimate the information content stored in a given set of CpG sites} \cite{Wang2017,Slieker2016,Hannum2013,Xie2011,Jenkinson2017}. I calculated it using the same approach as in Hannum \textit{et al.} \cite{Hannum2013}:
...
Besides Horvath's epigenetic clock, other models have been proposed in the literature to measure the ageing process using DNA methylation. Among them, Hannum's epigenetic clock has also been shown to accurately predict epigenetic age in several cohorts \cite{Chen2016,Marioni2015,Horvath2016,Marioni2018,Perna2016,Irvin2018}. Hannum's model was originally trained in whole blood and it makes use of a linear combination of $\beta$-values from 71 probes in the 450K array. 
