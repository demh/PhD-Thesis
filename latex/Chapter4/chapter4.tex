...
In the context of epigenetic clocks, most studies have used methylation arrays in humans \cite{Koch2011,Hannum2013,Horvath2013} and MspI-based RRBS in mice, dogs and wolves \cite{Thompson2017,Stubbs2017,Petkovich2017,Thompson2018,Meer2018}. The utility of the MspI-based RRBS approach is limited to a specific subset of CpG sites in the genome, mainly found within CpG islands and promoters \cite{Meissner2008}. Nevertheless, it is known that many age-related changes in the methylome occur in other genomic regions (such as enhancers) \cite{Cole2017,Slieker2016,Slieker2018,Martin-Herranz2019a}, and current technologies could be biasing our discoveries. Furthermore, epigenetic clocks could be used in the near future to perform high-throughput screenings of anti-ageing drugs or employed as ageing biomarkers in clinical trials \cite{Horvath2018a}. However, the current assay costs could preclude the use of epigenetic clocks in this context.
